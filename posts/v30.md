# WindiCSS v3 now in beta

Developers, it’s been a long time, I’m voorjaar. And here is windicss v3.
...
First of all, this is the utility syntax used by traditional tailwind, that is, all utilities and variants are written in the class.
...
5. You can check [another article](https://next.windicss.org/posts/attributify.html) for whole attributify mode details.
...
We introduced shortcuts in the [v2.2 version](https://next.windicss.org/posts/v22.html), allowing you to quickly reuse some commonly used combinations. For me, I like to use these shortcuts in the project, it will make my project look cleaner and tidy. I guess you all have your way of using it.
...
- [Filter](https://next.windicss.org/utilities/filters.html#filter)
- [Backdrop Filter](https://next.windicss.org/utilities/filters.html#backdrop-filter)
- [Mix Blend Mode](https://next.windicss.org/utilities/effects.html#mix-blend-mode)
- [Box Decoration Break](https://next.windicss.org/utilities/container.html#box-decoration-break)
- [Isolation](https://next.windicss.org/utilities/container.html#isolation)
- [Background Blend Mode](https://next.windicss.org/utilities/backgrounds.html#background-blend-mode)
- [Shadow Color](https://next.windicss.org/utilities/effects.html#box-shadow)
...
We are not far from completion. Check out another article on [windi lang](https://next.windicss.org/posts/language.html) to learn about the syntax. And your suggestions will be very valuable.
